...
//
//    private List<NeuronOutput> neuronHidesList;
//    private NeuronOutput[] neuronsHide;
...
//
//
//    public NeuralNetwork_ManyHideLayer(int numberInputNeurons, int numberOutputNeurons, int numberHideLayers){
//        neuronsHide = new NeuronOutput[numberOutputNeurons];
...
//            neuronsHide[i] = new NeuronOutput();
//    }
//
